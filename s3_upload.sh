...
# To copy all JSON reference data to the specified location:
aws s3 cp . s3://de-on-youtube-raw-useast1-dev/youtube /youtube/raw_statistics_reference_data/ --recursive --exclude "*" --include "*.json"
